...
export default function Footer() {
      ...
      <Container>
        <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10">
          ...
          <div className="flex justify-between items-center flex-wrap gap-4">
            <img className="text-black  dark:brightness-90 h-8 w-auto" src="/skill.png" alt="Gig Match Logo" />
  ...
  >
    ...
    <svg
    className="w-5 h-5 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
