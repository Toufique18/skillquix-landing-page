...
export default function Login() {
    ...
    return (
        <div className="flex min-h-screen bg-white">
            ...
            {/* Right Section - Login Form in Shadow Box */}
            <div className="flex w-full lg:w-1/2 flex-col justify-center items-center px-4 sm:px-8 lg:px-12 bg-gray-50 dark:bg-gray-900">
                <div className="w-full max-w-lg bg-white dark:bg-gray-800 p-8 sm:p-12 rounded-3xl shadow-[0_20px_50px_rgba(8,_112,_184,_0.07)] dark:shadow-[0_20px_50px_rgba(0,_0,_0,_0.3)] border border-gray-100 dark:border-gray-700">
                    {/* Logo */}
                    <div className="mb-10 ">
                    ...
                    <div className="mb-8 justify-between flex">
                        ...
                        <a href="#" className="text-sm font-bold text-red-600 hover:text-blue-700 transition-colors">Forgot password</a>
                    </div>

                    {/* Login Button */}
                    <button className="w-full rounded-xl bg-[#0F2B5A] py-4 font-bold text-white shadow-lg shadow-blue-500/30 hover:bg-blue-700 hover:shadow-blue-500/40 active:scale-[0.98] transition-all focus:outline-none focus:ring-4 focus:ring-blue-500/20">
                        Log in
                    </button>
